...
function About() {
    const skills = [
        { name: 'HTML', imgSrc: 'src/assets/html.jpeg', bgColor: 'bg-red-500' },
        { name: 'CSS', imgSrc: 'src/assets/css.jpeg', bgColor: 'bg-blue-500' },
        { name: 'JavaScript', imgSrc: 'src/assets/js.jpeg', bgColor: 'bg-yellow-500' },
        { name: 'React', imgSrc: 'src/assets/react.jpeg', bgColor: 'bg-cyan-500' },
        { name: 'Tailwind', imgSrc: 'src/assets/tailwind.jpeg', bgColor: 'bg-teal-500' },
        { name: 'Appwrite', imgSrc: 'src/assets/appwrite.png', bgColor: 'bg-pink-500' },
        { name: 'Python', imgSrc: 'src/assets/python.png', bgColor: 'bg-green-500' },
        { name: 'Github', imgSrc: 'src/assets/github.jpeg', bgColor: 'bg-gray-800' },
        { name: 'VS Code', imgSrc: 'src/assets/vs.jpeg', bgColor: 'bg-blue-800' },
        { name: 'C', imgSrc: 'src/assets/c.jpeg', bgColor: 'bg-green-800' },
        { name: 'C++', imgSrc: 'src/assets/C++.jpeg', bgColor: 'bg-cyan-800' },
    ];
